...
public class ServerGame {
     ...
     */
    public ServerGame(List<ServerPlayer> playersList) {
        this();
    ...
    public void newRound() {
        dealer.resetTurn();
        players.forEach(ServerPlayer::resetTurn);
    }
     ...
     */
    public void split(ServerPlayer player, Hand hand) {
     ...
     */
    public Card doubleDown(ServerPlayer player) {
     ...
     */
    public void insure(ServerPlayer player) {
        if (!canInsure(player)) {
     ...
     * (Precondition: player is nonnull)
     */
    public void payBet(ServerPlayer player) {
     ...
     */
    public ArrayList<ServerPlayer> removeMoneyless() {
        ArrayList<ServerPlayer> moneyless = new ArrayList<>();
     ...
     */
    public boolean canInsure(ServerPlayer player) {
    ...
    public ServerPlayer removePlayer(String name){
        for(int i = 0; i < players.size(); i++){
            if(players.get(i).getPlayerName().equals(name)){
                ServerPlayer playertoRemove = players.get(i);
                players.remove(i);
